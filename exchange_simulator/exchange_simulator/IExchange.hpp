#pragma once
// Do NOT modify this file or your code will not compile against Tibra's version.
#include <functional>
#include <string>
#include <ostream>
...
enum class InsertError {
	OK, SymbolNotFound, InvalidPrice,
	InvalidVolume, SystemError
};
...
public:
	...
	using OrderDeletedFunction = std::function<void(OrderId,
		DeleteError)>;
